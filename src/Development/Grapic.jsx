...
import Graphic from "../assets/grapic.png"
...
const WebDevelopmentFeatures = () => {
  ...
  return (
    ...
    <div className=" text-white">
      {/* Header Section */}
        <div className="text-center h-[441px] bg-gradient-to-b from-[#4C02F1] to-[#06044A] flex justify-center items-center px-6 md:px-20">
          <div><h1 className="text-3xl md:text-5xl font-bold">
        ...
        >
          ...
          <div>
            <img className=" w-[400px]" src={Graphic2}/>
          </div>
