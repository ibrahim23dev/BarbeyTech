...
const WebDevelopmentFeatures = () => {
  ...
  return (
    ...
    <div className=" text-white ">
      {/* Header Section */}
        <div className="text-center bg-gradient-to-b flex justify-center items-center  from-[#4C02F1] to-[#06044A] h-[441px] px-6 md:px-20">
          
          <div><h1 className="text-3xl md:text-4xl font-bold">
